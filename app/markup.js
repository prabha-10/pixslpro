...
export const MARKUP = `
  ...
  <svg width="0" height="0" style="position:absolute" aria-hidden="true" focusable="false">
    <!-- Figma -->
    <symbol id="l-figma" viewBox="0 0 256 384">
      <g>
    ...
    <!-- WordPress -->
    <symbol id="l-wordpress" viewBox="0 0 256 255">
      <g fill="#21759B">
    ...
    <!-- Next.js -->
    <symbol id="l-next" viewBox="0 0 256 256">
      <defs>
        <circle id="nextjs-path-1" cx="128" cy="128" r="128"></circle>
    ...
    <g>
        <mask id="nextjs-mask-2" fill="white">
            <use href="#nextjs-path-1"></use>
        </mask>
        <g mask="url(#nextjs-mask-2)">
    ...
    <!-- React -->
    <symbol id="l-react" viewBox="0 0 256 228">
      <g>
    ...
    <!-- Node.js -->
    <symbol id="l-node" viewBox="0 0 256 289">
      <g>
    ...
    <!-- Google Analytics -->
    <symbol id="l-ga" viewBox="0 0 256 284">
      <g>
    ...
    <symbol id="l-gsc" viewBox="0 0 256 228">
      <defs>
    ...
    <!-- Claude -->
    <symbol id="l-claude" viewBox="0 0 256 257">
      <g>
  ...
  <main>
    ...
    <section class="hero" id="section-hero">
      ...
      <div class="container">
        <div class="hero-inner">
          <h1 class="reveal" style="--d:.08s">From idea to launched website in two weeks.</h1>
          <p class="hero-sub reveal" style="--d:.16s">Pixsl Studio offers web design and development services that get you from goals to a launched site fast. You sign off on a working preview before we build the full site, and whether it is a new website, a custom build, or a rescue of the one you have, you get a fixed quote up front and own everything at launch.</p>
          <div class="hero-ctas reveal" style="--d:.24s">
            ...
            <a href="#section-projects" class="btn btn-light">See our work</a>
          </div>
    ...
    <!-- ============ 4. PROBLEM ============ -->
    <section id="section-problem" style="padding:72px 0">
      <div class="container">
      ...
      <div class="container">
        ...
        <div class="stats-grid">
          ...
          <div class="card stat-card cta-card reveal" style="--d:.16s">
            ...
            <p>A fixed quote, a working preview you approve, and a site that is live in 10 to 14 days.</p>
        ...
        <div class="container">
          <div class="services-top">
            <div class="section-head left" style="margin-bottom:0">
              <h2>Web design and development services,<span class="dim">plus custom software and branding.</span></h2>
            </div>
          ...
          <div class="services-body">
            <div class="service-list" id="serviceList">
              <div class="service-item active" data-index="0">
                <button class="service-head" aria-expanded="true">
                  <span class="service-title"><span class="service-num">01</span> Website design and development</span>
                ...
                <div class="service-panel"><div>
                  <p>New sites, rescues, and online stores. Your work has moved on and your website has not, so we build the one that matches it: a Signature Website, a rescue of the site you have, or an ecommerce store with catalogue and checkout. Mobile-first and search-ready, on WordPress or Next.js.</p>
                  <a href="#section-pricing" class="service-link" style="display:inline-flex;align-items:center;gap:6px;margin-top:14px;font-weight:600;color:var(--accent)">See website plans
                    <svg width="14" height="14" viewBox="0 0 16 16" fill="none"><path d="M3 8h10M9 4l4 4-4 4" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>
                  </a>
                </div></div>
              </div>
              <div class="service-item" data-index="1">
                <button class="service-head" aria-expanded="false">
                  <span class="service-title"><span class="service-num">02</span> Custom software and apps</span>
                  <span class="service-chevron">
                    <svg width="14" height="14" viewBox="0 0 16 16" fill="none"><path d="M4 6l4 4 4-4" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>
                  </span>
                </button>
                <div class="service-panel"><div>
                  <p>When a website is not enough. The spreadsheet holding your process together is slowing you down. We build client portals, dashboards, booking tools, and internal apps around the way your team actually works.</p>
                  <a href="#section-contact" class="service-link" style="display:inline-flex;align-items:center;gap:6px;margin-top:14px;font-weight:600;color:var(--accent)">Talk to us
                    <svg width="14" height="14" viewBox="0 0 16 16" fill="none"><path d="M3 8h10M9 4l4 4-4 4" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>
                  </a>
                </div></div>
              </div>
              <div class="service-item" data-index="2">
                <button class="service-head" aria-expanded="false">
                  <span class="service-title"><span class="service-num">03</span> Branding and digital assets</span>
                  <span class="service-chevron">
                    <svg width="14" height="14" viewBox="0 0 16 16" fill="none"><path d="M4 6l4 4 4-4" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>
                  </span>
                </button>
                <div class="service-panel"><div>
                  <p>Look as sharp as the work. An inconsistent brand makes strong work look smaller. We shape the logo, colours, and type, plus the social and profile assets that make you recognisable everywhere a client checks you out.</p>
                  <a href="#section-contact" class="service-link" style="display:inline-flex;align-items:center;gap:6px;margin-top:14px;font-weight:600;color:var(--accent)">Talk to us
                    <svg width="14" height="14" viewBox="0 0 16 16" fill="none"><path d="M3 8h10M9 4l4 4-4 4" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>
                  </a>
                </div></div>
              ...
              <div class="service-item" data-index="3">
                <button class="service-head" aria-expanded="false">
                  <span class="service-title"><span class="service-num">04</span> Website care and hosting</span>
                  <span class="service-chevron">
                    <svg width="14" height="14" viewBox="0 0 16 16" fill="none"><path d="M4 6l4 4 4-4" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>
                  </span>
                </button>
                <div class="service-panel"><div>
                  <p>Stay live and fast after launch. A site nobody maintains drifts and slows down. We handle managed hosting, maintenance with a set response window, content and gallery updates as new projects ship, and uptime and page-speed monitoring.</p>
                  <a href="#section-pricing" class="service-link" style="display:inline-flex;align-items:center;gap:6px;margin-top:14px;font-weight:600;color:var(--accent)">See care plans
                    <svg width="14" height="14" viewBox="0 0 16 16" fill="none"><path d="M3 8h10M9 4l4 4-4 4" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>
                  </a>
                </div></div>
              </div>
            ...
            <div class="service-visual" id="serviceVisual">
              <div class="visual-slide active">
                <div class="ph"><span class="ph-label">Website design &amp; development</span></div>
                <span class="visual-chip">Signature · Rescue · Ecommerce</span>
              </div>
              <div class="visual-slide">
                <div class="ph" style="background:linear-gradient(135deg,#dfe2e7,#f6f7f8 50%,#e8eaee)"><span class="ph-label">Custom software &amp; apps</span></div>
                <span class="visual-chip">Portals · Dashboards · Tools</span>
              </div>
              <div class="visual-slide">
                <div class="ph" style="background:linear-gradient(150deg,#e8eaee,#eef0f3 55%,#dfe2e7)"><span class="ph-label">Branding &amp; digital assets</span></div>
                <span class="visual-chip">Logo · Identity · Assets</span>
              </div>
              <div class="visual-slide">
                <div class="ph" style="background:linear-gradient(120deg,#eef0f3,#e2e5ea 60%,#f6f7f8)"><span class="ph-label">Website care &amp; hosting</span></div>
                <span class="visual-chip">Hosting · Updates · Monitoring</span>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="process" id="section-process">
      <div class="container">
        <div class="section-head reveal">
          <h2>How we work.<span class="dim">Working preview first, days not months.</span></h2>
          <p class="sub">You shape a real working version of the site early and approve it, then we build from there. You get a fixed quote up front and own everything at launch.</p>
        </div>
        <div class="process-grid">
          <div class="card process-card reveal">
            <span class="process-num">01</span>
            <h3>Requirements &amp; plan</h3>
            <p>We map what the site needs to do and who it is for, then agree a fixed quote and a clear plan. No hourly billing, no moving scope.</p>
          ...
          <div class="card process-card reveal" style="--d:.08s">
            ...
            <h3>Working preview (MVP)</h3>
            <p>You get a real, clickable preview of the site early, not a static mockup. You try it and shape it before we build the rest, so the direction is right from the start.</p>
          ...
          <div class="card process-card reveal">
            ...
            <h3>Build &amp; launch</h3>
            <p>We build the approved preview into the full site, connect analytics and lead capture, and put your best work front and centre.</p>
        ...
        <div class="pricing-grid">
          <div class="card price-card reveal">
            ...
            <ul class="plan-features">
              ...
              <li><span class="check"><svg width="10" height="10" viewBox="0 0 12 12" fill="none"><path d="M2 6.5L4.5 9L10 3.5" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></span>Working preview you approve before build</li>
            </ul>
          ...
          <div class="card price-card featured-plan reveal" style="--d:.08s">
            ...
            <ul class="plan-features">
              ...
              <li><span class="check"><svg width="10" height="10" viewBox="0 0 12 12" fill="none"><path d="M2 6.5L4.5 9L10 3.5" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></span>Working preview you approve before code</li>
      ...
      <div class="container">
        ...
        <div class="card compare reveal">
          ...
          <div class="compare-row">
            <div class="crit">Fixed quote up front.</div>
          ...
          <div class="compare-row">
            <div class="crit">You approve a working preview.</div>
            <div class="good"><span class="mark yes"><svg width="10" height="10" viewBox="0 0 12 12" fill="none"><path d="M2 6.5L4.5 9L10 3.5" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></span>Real working preview first</div>
          ...
          <div class="compare-row">
            ...
            <div class="good"><span class="mark yes"><svg width="10" height="10" viewBox="0 0 12 12" fill="none"><path d="M2 6.5L4.5 9L10 3.5" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></span>Your real work front and centre</div>
        ...
        <div class="faq-body">
          ...
          <div class="faq-list reveal" style="--d:.08s">
            <div class="faq-item open">
              ...
              <div class="faq-a"><div><p>A Signature Website starts at about AED 4,000, roughly USD 1,100, and most land between AED 4,000 and 5,000. Rescue projects, custom software, ecommerce builds, and care plans are quoted after a short call. You always get a fixed number before we start.</p></div></div>
            </div>
            <div class="faq-item">
            ...
            <div class="faq-item">
              <button class="faq-q" aria-expanded="false">
                Do I see the site before you build it?
                <span class="faq-icon"><svg width="12" height="12" viewBox="0 0 16 16" fill="none"><path d="M8 3v10M3 8h10" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg></span>
              </button>
              <div class="faq-a"><div><p>Yes. Early on you get a real, clickable working preview, not a static mockup. You try it and shape it, and we only build out the full site once you are happy with the direction.</p></div></div>
            </div>
            <div class="faq-item">
              <button class="faq-q" aria-expanded="false">
              ...
              <div class="faq-a"><div><p>Yes. We work with owner-led businesses across the Middle East, the UK, Europe, the US, India, and Southeast Asia, and we are remote-friendly. We have deep experience with premium trades like home automation, fit-out, and AV.</p></div></div>
            </div>
            <div class="faq-item">
              <button class="faq-q" aria-expanded="false">
            ...
            <div class="faq-item">
              ...
              <div class="faq-a"><div><p>You do. The domain, code, content, and every account sit in your name. Stay on a care plan if you want us around, or take the keys, there is no lock-in.</p></div></div>
            </div>
            <div class="faq-item">
              <button class="faq-q" aria-expanded="false">
            ...
            <div class="faq-item">
              ...
              <div class="faq-a"><div><p>Either a clean handover with a walkthrough, or a Website Care plan: managed hosting, maintenance with a set response window, monthly content and gallery updates, and page-speed monitoring.</p></div></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- ============ 14b. WHERE WE WORK + GROW INTO MORE ============ -->
    <section id="section-reach" style="padding:72px 0">
      <div class="container">
        <div class="section-head reveal">
          <h2>Where we work.<span class="dim">Remote-first, worldwide.</span></h2>
        </div>
        <div class="reveal" style="max-width:640px;margin:0 auto 36px;text-align:center">
          <p>We build for owner-led businesses across the Middle East, the UK, Europe, the US, India, and Southeast Asia. Local to the UAE? We know the market well, from home automation to fit-out.</p>
        </div>
        <div class="reveal" style="max-width:640px;margin:0 auto;text-align:center;padding-top:28px;border-top:1px solid var(--bg-line)">
          <p>Growing past the website? Two sister studios take it further: <a href="#section-contact" style="color:var(--accent);font-weight:600">Pixsl Flow</a> for automation and AI agents, and <a href="#section-contact" style="color:var(--accent);font-weight:600">Pixsl Rank</a> for SEO and visibility. We keep this studio focused on the build, and point you their way when you are ready.</p>
        </div>
      </div>
    </section>
  ...
  <script type="application/ld+json">
  {
    ...
    "description": "Pixsl Studio offers web design and development services, custom software, and branding for owner-led businesses worldwide. From idea to launched website in two weeks, on a fixed quote, with a working preview you approve before we build.",
    "founder": { "@type": "Person", "name": "Prabha" },
    "priceRange": "AED 4,000+",
    "currenciesAccepted": "AED, USD, EUR, INR",
    "areaServed": [
    ...
    "knowsAbout": ["Web design", "Web development", "Website redesign", "Ecommerce websites", "Custom software", "Branding", "Website maintenance"],
    "makesOffer": [
      {
        "@type": "Offer",
        "itemOffered": { "@type": "Service", "name": "Website design and development", "description": "New Signature Websites, rescues and rebuilds of existing sites, and ecommerce stores with catalogue and checkout, on WordPress or Next.js. Mobile-first and search-ready, with a working preview you approve before we build." },
        "priceCurrency": "AED",
        "price": "4000",
      ...
      {
        "@type": "Offer",
        "itemOffered": { "@type": "Service", "name": "Custom software and apps", "description": "Client portals, dashboards, booking tools, and internal apps built around how your team actually works." }
      },
      {
        "@type": "Offer",
        "itemOffered": { "@type": "Service", "name": "Branding and digital assets", "description": "Logo, colours, and type, plus the social and profile assets that make a business recognisable everywhere clients check it out." }
      },
      {
        "@type": "Offer",
        "itemOffered": { "@type": "Service", "name": "Website care and hosting", "description": "Managed hosting, maintenance with a set response window, content and gallery updates, and uptime and page-speed monitoring." }
      }
    ]
  }
  </script>
    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": { "@type": "Answer", "text": "A Signature Website starts at about AED 4,000, roughly USD 1,100, and most land between AED 4,000 and 5,000. Rescue projects, custom software, ecommerce builds, and care plans are quoted after a short call. You always get a fixed number before we start." }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "Do I see the site before you build it?",
        "acceptedAnswer": { "@type": "Answer", "text": "Yes. Early on you get a real, clickable working preview, not a static mockup. You try it and shape it, and we only build out the full site once you are happy with the direction." }
      },
      {
        "@type": "Question",
        "name": "Do you work with businesses outside the UAE?",
        "acceptedAnswer": { "@type": "Answer", "text": "Yes. We work with owner-led businesses across the Middle East, the UK, Europe, the US, India, and Southeast Asia, and we are remote-friendly. We have deep experience with premium trades like home automation, fit-out, and AV." }
      },
      {
        "@type": "Question",
      ...
      },
      {
        ...
        "acceptedAnswer": { "@type": "Answer", "text": "You do. The domain, code, content, and every account sit in your name. Stay on a care plan if you want us around, or take the keys, there is no lock-in." }
      },
      {
        "@type": "Question",
      ...
      },
      {
        ...
        "acceptedAnswer": { "@type": "Answer", "text": "Either a clean handover with a walkthrough, or a Website Care plan: managed hosting, maintenance with a set response window, monthly content and gallery updates, and page-speed monitoring." }
      }
    ]
  }
  </script>
